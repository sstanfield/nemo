...
//      print("${s.type} ${s.depth} ${dive.mbarToDepth(s.depth)} ${s.time} $runtime");
  ...
  test('60 meter for 60 test', () {
    ...
    List<Segment> expectedSegs = new List<Segment>();
    expectedSegs.add(new Segment(SegmentType.DOWN, 7001, 0.0, 4, Gas.air, false, 0, 0.0, 0.0, 1.2));
    expectedSegs.add(new Segment(SegmentType.LEVEL, 7001, 0.0, 56, Gas.air, false, 0, 0.0, 0.0, 1.2));
    expectedSegs.add(new Segment(SegmentType.UP, 4301, 0.0, 3, Gas.air, false, 0, 0.0, 0.0, 1.2));
    expectedSegs.add(new Segment(SegmentType.LEVEL, 4301, 0.0, 2, Gas.air, false, 0, 0.0, 0.0, 1.2));
    expectedSegs.add(new Segment(SegmentType.LEVEL, 4001, 0.0, 3, Gas.air, false, 0, 0.0, 0.0, 1.2));
    expectedSegs.add(new Segment(SegmentType.LEVEL, 3701, 0.0, 6, Gas.air, false, 0, 0.0, 0.0, 1.2));

    // Shearwater 8min
    expectedSegs.add(new Segment(SegmentType.LEVEL, 3401, 0.0, 7, Gas.air, false, 0, 0.0, 0.0, 1.2));
    expectedSegs.add(new Segment(SegmentType.LEVEL, 3101, 0.0, 5, Gas.air, false, 0, 0.0, 0.0, 1.2));
    expectedSegs.add(new Segment(SegmentType.LEVEL, 2801, 0.0, 6, Gas.air, false, 0, 0.0, 0.0, 1.2));
    expectedSegs.add(new Segment(SegmentType.LEVEL, 2501, 0.0, 9, Gas.air, false, 0, 0.0, 0.0, 1.2));

    // Shearwater 12min
    expectedSegs.add(new Segment(SegmentType.LEVEL, 2201, 0.0, 13, Gas.air, false, 0, 0.0, 0.0, 1.2));

    // Shearwater 20min
    expectedSegs.add(new Segment(SegmentType.LEVEL, 1901, 0.0, 19, Gas.air, false, 0, 0.0, 0.0, 1.2));
    expectedSegs.add(new Segment(SegmentType.LEVEL, 1601, 0.0, 24, Gas.air, false, 0, 0.0, 0.0, 1.2));

    // Shearwater 46min
    expectedSegs.add(new Segment(SegmentType.LEVEL, 1301, 0.0, 45, Gas.air, false, 0, 0.0, 0.0, 1.2));
    int i = 0;
//    int runtime = 0;
//    double cns = 0.0;
//    double otu = 0.0;
...
//    print("otu: $otu, cns: $cns");
  ...
  test('200 feet for 60 test', () {
    ...
    expect(segs.length, 14);
    List<Segment> expectedSegs = new List<Segment>();
    expectedSegs.add(new Segment(SegmentType.DOWN, 7109, 0.0, 4, Gas.air, false, 0, 0.0, 0.0, 1.2));
    expectedSegs.add(new Segment(SegmentType.LEVEL, 7109, 0.0, 56, Gas.air, false, 0, 0.0, 0.0, 1.2));
    expectedSegs.add(new Segment(SegmentType.UP, 4368, 0.0, 3, Gas.air, false, 0, 0.0, 0.0, 1.2));
    expectedSegs.add(new Segment(SegmentType.LEVEL, 4368, 0.0, 2, Gas.air, false, 0, 0.0, 0.0, 1.2));
    expectedSegs.add(new Segment(SegmentType.LEVEL, 4063, 0.0, 4, Gas.air, false, 0, 0.0, 0.0, 1.2));
    expectedSegs.add(new Segment(SegmentType.LEVEL, 3758, 0.0, 6, Gas.air, false, 0, 0.0, 0.0, 1.2));
    expectedSegs.add(new Segment(SegmentType.LEVEL, 3453, 0.0, 7, Gas.air, false, 0, 0.0, 0.0, 1.2));
    expectedSegs.add(new Segment(SegmentType.LEVEL, 3148, 0.0, 5, Gas.air, false, 0, 0.0, 0.0, 1.2));
    expectedSegs.add(new Segment(SegmentType.LEVEL, 2843, 0.0, 6, Gas.air, false, 0, 0.0, 0.0, 1.2));
    expectedSegs.add(new Segment(SegmentType.LEVEL, 2538, 0.0, 9, Gas.air, false, 0, 0.0, 0.0, 1.2));
    expectedSegs.add(new Segment(SegmentType.LEVEL, 2233, 0.0, 13, Gas.air, false, 0, 0.0, 0.0, 1.2));
    expectedSegs.add(new Segment(SegmentType.LEVEL, 1928, 0.0, 20, Gas.air, false, 0, 0.0, 0.0, 1.2));
    expectedSegs.add(new Segment(SegmentType.LEVEL, 1623, 0.0, 24, Gas.air, false, 0, 0.0, 0.0, 1.2));
    expectedSegs.add(new Segment(SegmentType.LEVEL, 1318, 0.0, 46, Gas.air, false, 0, 0.0, 0.0, 1.2));
    int i = 0;
//    int runtime = 0;
    for (var s in segs) {
//      runtime += s.time;
