...
class OtuCns {
  ...
  static final List<double> _cnsLimitSlope = [-1800.0, -1500.0, -1200.0, -900.0, -600.0, -300.0, -750.0];
  static final List<double> _cnsLimitIntercept = [1800.0, 1620.0, 1410.0, 1170.0, 900.0, 570.0, 1245.0];
  ...
  static List<double> descent(int rateMbar, int fromDepth, int toDepth, Gas gas) {
